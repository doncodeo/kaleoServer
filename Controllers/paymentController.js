...
//         // Schedule a job to handle membership expiration and renewal
//         schedule.scheduleJob(endDate, async () => {
//             const expiredUser = await User.findById(user._id);
//             if (expiredUser) {
//                 if (subscription.renewalType === 'automatic') {
//                     // Create a new payment for automatic renewal
...
//                         tx_ref: renewalPayment._id.toString(),
//                         amount: renewalPayment.amount,
//                         currency: 'NGN',
//                         redirect_url: 'https://your-ngrok-url/payment-success', 
//                         customer: {
//                             email: expiredUser.email,
//                             phonenumber: expiredUser.phoneNumber,
//                             name: `${expiredUser.firstName} ${expiredUser.lastName}`
//                         },
//                         customizations: {
...
//                     const renewalResponse = await axios.post('https://api.flutterwave.com/v3/payments', renewalPaymentData, {
//                         headers: {
//                             Authorization: `Bearer ${FLUTTERWAVE_SECRET_KEY}`
//                         }
//                     });

//                     // Update user status to pending renewal
//                     expiredUser.membershipStatus = 'pending';
//                     await expiredUser.save();
//                 } else {
//                     // Set membership status to inactive for manual renewal
//                     expiredUser.membershipStatus = 'inactive';
//                     await expiredUser.save();
//                 }
//             }
//         });
